...
Liste canonique (parsable) des `reasonCode` publics v1:
...
- `CMD.NOT_FOUND.SECURITY.INDISTINGUISHABLE`
- `CMD.INTERNAL.EVENTSTORE.WRITE_FAILED`
- `CMD.INTERNAL.EVENTSTORE.CORRUPT_TX_INDEX`
- `CMD.INTERNAL.REPLICATION.DIVERGENCE_DETECTED`
- `CMD.PRECONDITION.REPLICATION.ORDER_GAP`
- `CMD.VALIDATION.SNAPSHOT.UNSUPPORTED_VERSION`
