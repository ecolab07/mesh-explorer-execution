...
try {
  ...
  run("git diff --exit-code -- artifacts/conformance-evidence.md artifacts/conformance-evidence.critical.md artifacts/conformance-evidence.persistent.md artifacts/conformance-evidence.json");
} catch {
